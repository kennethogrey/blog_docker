...
@section('meta_tags')
    ...
    <meta property="og:image" content="/storage/images/post_images/thumbnails_resized_{{$post->featured_image}}">
    ...
    <meta name="twitter:image" content="/storage/images/post_images/thumbnails_resized_{{$post->featured_image}}">
@endsection
@section('content')
    <div class="row">
